...
Page({
  ...
  onCategorySelected(e) {
    ...
    const formData = {
      ...
      recordType: currentRecord.recordType || null,
      amount: currentRecord.amount || null,
      recordTime: currentRecord.recordTime || null,
      remark: currentRecord.remark || null
    };
  ...
  onAmountConfirmed(e) {
    ...
    const formData = {
      id: currentRecord.id,
      categoryId: currentRecord.categoryId || null,
      recordType: currentRecord.recordType || null,
      amount: amount || null,
